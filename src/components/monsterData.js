 const data = [
    ...
    {
        nombre: 'impostor',
        url: '/images/monstruos/monstruo3.png',
    ...
    {
        nombre: 'meses',
        url: '/images/monstruos/monstruo4.png',
    ...
    {
        nombre: 'saboteador',
        url: '/images/monstruos/monstruo5.png',
    ...
    {
        nombre: 'credito',
        url: '/images/monstruos/monstruo6.png',
    ...
    {
        nombre: 'imprevistos',
        url: '/images/monstruos/monstruo7.png',
    ...
    {
        nombre: 'hormiga',
        url: '/images/monstruos/monstruo8.png',
    ...
    {
        nombre: 'ultimo',
        url: '/images/monstruos/monstruo9.png',
        pregunta: 'Ves en redes sociales que está moda un opción de invesión/negocio que genera grandes ganancias, solo necesitas invertir poco dinero e invitar a otros amigos para que se unan, tú:',
